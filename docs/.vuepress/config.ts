...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo: `Dreamer | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>
        </br>
         <a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2025379918号</a>
